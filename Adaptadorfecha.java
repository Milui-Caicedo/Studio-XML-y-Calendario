...
public class Adaptadorfecha extends BaseAdapter {
    ...
    public Adaptadorfecha(Activity activity){
        ...
        referenceArch = database.getReference("Eventos");
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        borrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String aquitar = eventos.get(i).getId();
                DatabaseReference ref = database.getReference("Eventos").child(aquitar);
                ref.setValue(null);
    ...
    public void addevento(Evento nuevo){
        ...
        nuevo.setId(id);
        DatabaseReference ref = database.getReference("Eventos").child(id);
        ref.setValue(nuevo);
    }
}
